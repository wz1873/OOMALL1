...
@Transactional
public class AdminControllerTestJYX {
...
@Test
   ...
   /* *
     ...
     */
    @Test
    public void testGETProductIdGivenFound2() throws Exception {
  ...
  @Test
    public void testGETProductIdGivenFound() throws Exception {
        ...
        Mockito.when(shopMapper.getTemplateById(10L,1L)).thenReturn(retTemplate);
        this.mockMvc.perform(MockMvcRequestBuilders.get("/shops/{shopId}/products/{id}", 10, 1550)
                        .header("authorization", adminToken)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  @Test
   ...
   /* *
    ...
    public void testAllowProductGivenFail()throws Exception{
        Mockito.when(redisUtil.hasKey("P1550")).thenReturn(false);
        this.mockMvc.perform(MockMvcRequestBuilders.put("/shops/{shopId}/products/{id}/allow",10,1550)
                        .header("authorization", adminToken)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void testAllowProductGivenSuccess()throws Exception{
        Mockito.when(redisUtil.hasKey("P1550")).thenReturn(false);
        this.mockMvc.perform(MockMvcRequestBuilders.put("/shops/{shopId}/products/{id}/allow",0,1550)
                        .header("authorization", adminToken)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk());
    ...
    public void testProhibitProductGivenFail()throws Exception{
        Mockito.when(redisUtil.hasKey("P1550")).thenReturn(false);
        this.mockMvc.perform(MockMvcRequestBuilders.put("/shops/{shopId}/products/{id}/prohibit",10,1550)
                        .header("authorization", adminToken)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().is4xxClientError());
  ...
  @Test
    public void testProhibitProductGivenSuccess()throws Exception{
        Mockito.when(redisUtil.hasKey("P1550")).thenReturn(false);
        this.mockMvc.perform(MockMvcRequestBuilders.put("/shops/{shopId}/products/{id}/prohibit",0,1550)
                        .header("authorization", adminToken)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk());
     ...
     */
    @Test
    public void testGetProdcutByTemplateGivenSuccess()throws Exception{
        Mockito.when(redisUtil.hasKey("P1550")).thenReturn(false);
