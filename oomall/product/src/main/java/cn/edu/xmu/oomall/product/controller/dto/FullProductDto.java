...
public class FullProductDto {
    ...
    private IdNameTypeDto shopLogistic;
    ...
    public FullProductDto(Product product){
        ...
        this.setShopLogistic1(IdNameTypeDto.builder().id(product.getLogistics().getId()).name(product.getLogistics().getName()).build());
    ...
    public IdNameTypeDto getShopLogistic() {
        return shopLogistic;
    }

    public void setShopLogistic1(IdNameTypeDto shopLogistic) {
