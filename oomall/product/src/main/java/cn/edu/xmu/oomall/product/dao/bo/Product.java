...
public class Product extends OOMallObject implements Serializable {
    ...
    public Logistics getLogistics(){
        if(null == this.shopId || null == this.shopLogisticId){
            throw new BusinessException(ReturnNo.INCONSISTENT_DATA, String.format(ReturnNo.INCONSISTENT_DATA.getMessage(), "产品", this.id, "shopId或shopLogisticId为空"));
        }
