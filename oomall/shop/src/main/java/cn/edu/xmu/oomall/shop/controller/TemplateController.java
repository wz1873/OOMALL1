...
<<<<<<< HEAD
=======
        bo.setFirstWeightPrice(vo.getFirstWeightFreight());
...
<<<<<<< HEAD
=======
        bo.setFirstItems(vo.getFirstItem());
        bo.setFirstPrice(vo.getFirstItemPrice());
        bo.setAdditionalPrice(vo.getAdditionalItemsPrice());
>>>>>>> 3a200f3f810107b4c3bb38ad75f6101ae897f920
