...
public class UnAuthorizedController {
    ...
    public ReturnObject retriveRegionIdByName(@PathVariable String name){
        Long regionId=this.regionService.retriveRegionIdByName(name);
        return new ReturnObject(regionId);
    }
}
